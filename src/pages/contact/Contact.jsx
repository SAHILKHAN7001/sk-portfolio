      ...
      <section className="contact-section">
        ...
        <form ref={form} className="contact-form" onSubmit={onSubmit}>
          <div>
            ...
            <Fade bottom>
              <p>
                I’m interested in Internship or Jobs opportunities and I am always ready
                to build projects at anytime, if you have any job offer for me,
                you could use the form below to reach out to me.
              </p>
            </Fade>
          </div>
          <Fade bottom>
          ...
          <Reveal bottom>
            <footer className="footer">
              <p> &copy; copyright All Right Reserved Sahil Khan - 2022</p>
            </footer>
          </Reveal>
        </form>
